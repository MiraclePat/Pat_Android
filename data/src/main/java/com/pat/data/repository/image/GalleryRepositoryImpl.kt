...
class GalleryRepositoryImpl @Inject constructor(
    ...
    private val pickImagesResult = (context as AppCompatActivity).registerForActivityResult(
        ActivityResultContracts.PickMultipleVisualMedia(MAX_SELECT_IMAGE_COUNT)) { uris ->
